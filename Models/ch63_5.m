...
osci_freq1 = zeros(1, length(G2_in));
osci_freq2 = zeros(1, length(G2_in));
%% 
for k = 1:length(G2_in) %iterate through different input conductance values from 0 to 10 pS
...
plot(G2_in(2:length(G2_in)), osci_freq1(2:length(osci_freq1)));
%hold on
